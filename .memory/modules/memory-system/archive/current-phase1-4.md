...
### In Progress (Phase 5 Revised - Practical Improvements)
- [x] Phase 1 완료 ✅
- [x] Phase 2 완료 ✅
- [x] Phase 3 완료 (벡터 검색) ✅
- [x] Phase 4 완료 (LLM 통합) ✅
...
- [ ] 문서 관리 개선 (최우선) 🎯
  - [ ] current/decisions 길어졌을 때 처리 방법 고안
  - [ ] 아카이브, 요약, 분할 전략
- [ ] SQLite 인덱싱 (검색 속도 개선)
- [ ] 검색 개선 (하이브리드, 랭킹)
- [ ] 자동 요약 고도화
...
### Current Focus (Phase 5 Revised)
1. **문서 관리 개선** (최우선) 🎯
   - current.md, decisions.md가 길어졌을 때 처리 방법
   - 아카이브, 요약, 분할 전략 고안
   - 실사용 시 발견된 첫 문제
...
**MCP Server:** 우선순위 최하위로 이동 (1-7 완료 후 재평가)
