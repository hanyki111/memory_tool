...
```
1. Read .claude/guidelines.md (if exists)
2. Read .claude/memory-context.md (if exists)
```

**Guidelines** define module organization principles for this project.

**Memory Context** provides auto-generated context from:
...
**Key Rules:**
- **Split when:** current.md > 300 lines, >20 decisions, >3 distinct topics
- **Single responsibility:** Each module = one clear purpose
- **Check before creating:** Can describe in 1-2 sentences? Size >100 lines?
