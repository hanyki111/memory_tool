...
> **Template for integrating memory_tool with AI coding assistants**
>
> Copy to your project's `CLAUDE.md` (or `GEMINI.md`, etc.) file.
...
1. `.claude/guidelines.md` - Module organization, memory_tool usage
2. `.claude/memory-context.md` - Auto-generated project context (run `mcontext` to generate)

**For detailed documentation:**
- `.memory/docs/MODULE-ORGANIZATION-PRINCIPLES.md` - When to split/create modules
- `.memory/docs/QUICK-REFERENCE-MODULE-ORGANIZATION.md` - Decision checklists
...
mcontext -i              # Update module interface.md files

# Search
ms "query"               # Search local project
ms --with-kb "query"     # Search with knowledge base

# Verification
mcheck                   # Verify module paths
```

**Tip:** Run `mcontext` before starting AI session to ensure fresh context.
